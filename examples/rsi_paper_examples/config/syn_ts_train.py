...
def train_ssm_lstm(data_file):
    ...
    if "simple" in data_file:
        print("Training on simple time series data...")
        lstm_lbl = 13
    elif "complex" in data_file:
        print("Training on complex time series data...")
        lstm_lbl = 12
    ...
    import pickle
    model_saved_path = "saved_params/syn_ts_tsmodel_test.pkl"
    ...
    ax0.set_xticklabels([])
    ax0.set_title("Hidden states at the optimal epoch in training and validation")
    plot_states(
    data_processor=data_processor,
    standardization=True,
    states=states_optim,
